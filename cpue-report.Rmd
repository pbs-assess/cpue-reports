...
file_model <- here(paste0("data/generated/cpue-1996-models-", spp, "-", params$era, ".rds"))
...
write_csv(predictions, 
  here(paste0("data/generated/cpue-1996-predictions-", spp, "-", params$era, ".csv")))
```
...
predictions %>% 
  filter(formula_version %in% c("Unstandardized", "Full standardization RE")) %>% 
